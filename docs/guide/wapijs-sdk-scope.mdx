---
title: Scope of Wapi.go SDK
---

## Current Status

<Card>
  Currently, Wapi.go SDK support building almost all the type of message compoennt and sending them to customers. Listening to incoming event notification including user triggered and system generated events.
</Card>
